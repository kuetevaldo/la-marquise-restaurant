...
export default function MenuHero() {
  return (
    <section className="relative overflow-hidden border-b border-[var(--border)] bg-[var(--background)] pb-20 pt-16 sm:pb-24 sm:pt-20 md:pb-28">
      ...
      <div className="relative mx-auto w-full max-w-7xl px-6 sm:px-8 md:px-10 lg:px-12 xl:px-16">
        ...
        <h1
          className="premium-enter font-display max-w-5xl text-5xl font-medium leading-[0.94] tracking-tight text-[var(--foreground)] sm:text-6xl md:text-7xl lg:text-[82px]"
        ...
        <div
          className="premium-enter mt-10 grid max-w-5xl gap-8 border-t border-[var(--border)] pt-8 md:grid-cols-2"
          style={enterStyle(200, 800, 20)}
        >

          <div>
            <p className="text-[9px] font-semibold uppercase tracking-[0.25em] text-[var(--brand)]">
          ...
          <div>
            <p className="text-[9px] font-semibold uppercase tracking-[0.25em] text-[var(--fastfood-light)]">
        ...
        >
          <Link
            href="/"
            className="group inline-flex items-center gap-3 text-[9px] font-semibold uppercase tracking-[0.2em] text-[var(--muted-soft)] transition-colors duration-300 hover:text-[var(--brand-light)]"
          >
