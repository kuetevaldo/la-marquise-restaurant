      ...
      <div className="mx-auto w-full max-w-7xl px-6 sm:px-8 md:px-10 lg:px-12 xl:px-16">
        ...
        <Reveal>
          <div className="mb-14 flex flex-col gap-7 md:mb-16 md:flex-row md:items-end md:justify-between">
            ...
            <div>
              ...
              <h2 className="font-display max-w-2xl text-5xl font-medium leading-[0.96] tracking-tight text-[#f5f1e8] sm:text-6xl md:text-7xl">
                Une atmosphère
            ...
            <p className="max-w-md text-sm leading-7 text-[#aaa398] md:text-base md:leading-8">
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-4 md:gap-5">
          ...
          {gallery.map((image, index) => (
            ...
            >
              <div
                className={`group relative overflow-hidden bg-[#191814] ${
                  image.featured
