...
export default function Introduction() {
  return (
    <section
      id="about"
      className="bg-(--background) py-24 sm:py-28 md:py-32 lg:py-36"
    >
      <div className="mx-auto grid w-full max-w-7xl items-center gap-12 px-6 sm:px-8 md:px-10 lg:grid-cols-2 lg:gap-16 lg:px-12 xl:gap-20 xl:px-16">
        ...
        <Reveal>
          <div className="relative aspect-square w-full overflow-hidden bg-(--surface-elevated)">
            ...
            <div className="absolute bottom-5 left-5 border border-(--border) bg-(--background)/80 px-3 py-2">
        ...
        <Reveal delay={0.12}>
          <div className="w-full max-w-xl lg:justify-self-end">
            ...
            <div className="mt-8 h-px w-16 bg-(--border-strong)" />

            <p className="mt-8 max-w-lg text-sm leading-7 text-(--muted) md:text-base md:leading-8">
            ...
            <a
              href="#experience"
              className="group mt-9 inline-flex min-h-12 items-center gap-3 border-b border-(--border) text-[10px] font-semibold uppercase tracking-[0.18em] text-(--foreground) transition-colors duration-300 hover:border-(--brand) hover:text-(--brand-light) sm:text-[11px]"
            >
