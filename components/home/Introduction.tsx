...
export default function Introduction() {
  return (
    <section
      id="about"
      className="bg-[#0b0b0a] py-24 sm:py-28 md:py-32 lg:py-36"
    >
      <div className="mx-auto grid w-full max-w-7xl items-center gap-12 px-6 sm:px-8 md:px-10 lg:grid-cols-2 lg:gap-16 lg:px-12 xl:gap-20 xl:px-16">
        ...
        {/* Image reveal */}
        <Reveal>
          <div className="relative aspect-square w-full overflow-hidden bg-[#151411]">
            <Image
            ...
            <div className="absolute bottom-5 left-5 border border-white/15 bg-black/25 px-3 py-2 backdrop-blur-sm">
        ...
        <Reveal delay={0.12}>
          <div className="w-full max-w-xl lg:justify-self-end">
            ...
            <div className="mb-6 flex items-center gap-4">
              ...
              <p className="text-[10px] font-semibold uppercase tracking-[0.28em] text-[#b99a5b] sm:text-[11px]">
            ...
            <p className="mt-8 max-w-lg text-sm leading-7 text-[#aaa398] md:text-base md:leading-8">
            ...
            <a
              href="#experience"
              className="group mt-9 inline-flex min-h-12 items-center gap-3 border-b border-white/15 text-[10px] font-semibold uppercase tracking-[0.18em] text-[#f5f1e8] transition-colors duration-300 hover:border-[#b99a5b] hover:text-[#d8c49c] sm:text-[11px]"
            >
