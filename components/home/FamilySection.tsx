...
export default function FamilySection() {
  return (
    <section
      id="family"
      className="border-t border-[var(--border)] bg-[var(--surface-elevated)] py-24 sm:py-28 md:py-32 lg:py-36"
    >
      <div className="mx-auto grid w-full max-w-7xl items-center gap-12 px-6 sm:px-8 md:px-10 lg:grid-cols-2 lg:gap-12 lg:px-12 xl:gap-16 xl:px-16">
        ...
        <Reveal y={24}>
          <div className="order-2 w-full max-w-xl lg:order-1">
            ...
            <div className="mt-9 flex flex-col gap-3 sm:flex-row sm:flex-wrap">
              <a
                href="#reservation"
                className="group inline-flex min-h-14 items-center justify-center gap-3 bg-[var(--brand)] px-7 text-center text-[10px] font-semibold uppercase tracking-[0.16em] text-[var(--surface)] transition-colors duration-300 hover:bg-[var(--brand-light)] sm:px-8 sm:text-[11px]"
              >
                Réserver une table
              ...
              <a
                href="#events"
                className="group inline-flex min-h-14 items-center justify-center gap-3 border border-[var(--border-strong)] px-7 text-center text-[10px] font-semibold uppercase tracking-[0.16em] text-[var(--foreground)] transition-colors duration-300 hover:border-[var(--brand)] hover:bg-[var(--surface)] hover:text-[var(--brand-light)] sm:px-8 sm:text-[11px]"
              >
                Nos événements
                <span className="transition-transform duration-300 group-hover:translate-x-1">
                  →
        ...
        <Reveal delay={0.12} y={28}>
          <div className="order-1 w-full lg:order-2">
            <div className="group relative aspect-4/3 w-full overflow-hidden bg-[var(--surface-soft)]">
              <Image
              ...
              <div className="absolute bottom-5 left-5 border border-[var(--border)] bg-[var(--background)]/80 px-4 py-3">
